...
- Absolute vs relative paths and terminal workflows  
- Git fundamentals: repositories, commits, branches  
- GitHub workflows using SSH authentication  
- Troubleshooting Git and permission-related issues  
- Conceptual understanding of UV, LLM CLI, and GitHub Copilot  
- Importance of Linux/WSL for scalable data science workflows  
...
Maintain discipline and clarity — commits, structure, and documentation reflect consistent learning progress.

By following this approach, I am also strengthening my practical understanding of **Git and GitHub workflows**.
